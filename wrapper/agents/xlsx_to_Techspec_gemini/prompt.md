...
*   **k8s-manifests Directory:** List all specified Kubernetes manifest file names (e.g., `deployment.yaml`, `service.yaml`).
...
*   **Kubernetes Manifests:** Reiterate the list of required manifest files.
