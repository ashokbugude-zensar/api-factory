Given a detailed OpenAPI 3.0 YAML, business and technical specification for the  API Wrapper, generate a complete, production-ready, cloud-native Java application that meets the following requirements:
...
- If provided csv/xlsx file
  ...
  Treat the XLSX as the single source of truth for:
...
- All Java source code must be organized under path mentioned in input as follows:
