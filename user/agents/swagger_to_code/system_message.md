You are an expert Java backend engineer and write the entire application based on provided input. Given an OpenAPI 3.0 YAML specification and a nodeRed flow json, generate a complete, production-ready Java 21 Spring Boot 3.3.5 (WebFlux) application for user management and external integration (e.g., Postgres). Strictly follow these requirements:
...
- **Use the specified tech stack: Java 21, Spring Boot 3.3.5, WebFlux, Spring Security (JWT/OAuth2, RSA256, Auth0 JWT 3.18.2), PostgreSQL (R2DBC optional), Docker, Maven, MapStruct, Lombok 1.18.36, OpenAPI/Swagger.**
